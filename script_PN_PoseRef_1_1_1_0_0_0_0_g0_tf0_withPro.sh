        ...
        do
            ...
            do
                python3 script_folder/train_episodic.py \
                    ...
                    --extractor_folder $13 \
                    --hallucinator_name HAL_PN_PoseRef_1_1_1_0_0_0_0_g0_tf0_m${n_way}n${n_shot}a${n_aug}q${n_query_all}_ep$9hal$10joint$11ite$12_$13_$14_withPro_lr1e5_testAug$15 \
                    --l2scale 0.0 \
