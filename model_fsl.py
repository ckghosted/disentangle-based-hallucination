...
class FSL_PN_PoseRef_Before(FSL_PN_PoseRef):
    def __init__(self,
                 sess,
                 model_name,
                 result_path,
                 ...
                 use_canonical_gallery=False,
                 n_clusters_per_class=0):
        super(FSL_PN_PoseRef_Before, self).__init__(sess,
                                                    model_name,
                                                    result_path,
                                                    fc_dim,
                                                    n_class,
    ...
    def build_model(self):
        ...
        self.pose_feat = tf.placeholder(tf.float32, shape=[None, self.fc_dim], name='pose_feat')
        self.hallucinated_features, _ = self.transformer(self.pose_feat, self.real_feat_ave_tile, bn_train=self.bn_train, with_BN=self.with_BN)
    ...
    ## Add a transformer to encode the pose_ref into seed class
    def transformer(self, input_pose, input_class, bn_train, with_BN=False, epsilon=1e-5, reuse=False):
